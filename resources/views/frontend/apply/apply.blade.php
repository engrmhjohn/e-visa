...
@section('title', 'Apply Now | E-Visa')
<style>
    form select option {
        white-space: normal;
...
@section('content')
<div class="container apply-container mt-4">
    <div class="row">
        @php
        $currentStep = session('step', request('step', 1)); // default step = 1
        @endphp
        <!-- Sidebar Navigation -->
        <div class="col-md-3 col-lg-3 border-end form-sidebar">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <button class="nav-link {{ $currentStep == 1 ? 'active' : 'disabled' }}" id="v-pills-1-tab" data-bs-toggle="pill" data-bs-target="#v-pills-1" type="button" role="tab">1. Personal information</button>
                <button class="nav-link {{ $currentStep == 2 ? 'active' : 'disabled' }}" id="v-pills-2-tab" data-bs-toggle="pill" data-bs-target="#v-pills-2" type="button" role="tab">2. Type of visa</button>
                <button class="nav-link {{ $currentStep == 3 ? 'active' : 'disabled' }}" id="v-pills-3-tab" data-bs-toggle="pill" data-bs-target="#v-pills-3" type="button" role="tab">3. Work information</button>
                <button class="nav-link {{ $currentStep == 4 ? 'active' : 'disabled' }}" id="v-pills-4-tab" data-bs-toggle="pill" data-bs-target="#v-pills-4" type="button" role="tab">4. Education</button>
                <button class="nav-link {{ $currentStep == 5 ? 'active' : 'disabled' }}" id="v-pills-5-tab" data-bs-toggle="pill" data-bs-target="#v-pills-5" type="button" role="tab">5. Family information</button>
                <button class="nav-link {{ $currentStep == 6 ? 'active' : 'disabled' }}" id="v-pills-6-tab" data-bs-toggle="pill" data-bs-target="#v-pills-6" type="button" role="tab">6. Travel information</button>
                <button class="nav-link {{ $currentStep == 7 ? 'active' : 'disabled' }}" id="v-pills-7-tab" data-bs-toggle="pill" data-bs-target="#v-pills-7" type="button" role="tab">7. Previous travel info</button>
                <button class="nav-link {{ $currentStep == 8 ? 'active' : 'disabled' }}" id="v-pills-8-tab" data-bs-toggle="pill" data-bs-target="#v-pills-8" type="button" role="tab">8. Other information</button>
                <button class="nav-link {{ $currentStep == 9 ? 'active' : 'disabled' }}" id="v-pills-9-tab" data-bs-toggle="pill" data-bs-target="#v-pills-9" type="button" role="tab">9. Declaration</button>
                <button class="nav-link {{ $currentStep == 10 ? 'active' : 'disabled' }}" id="v-pills-10-tab" data-bs-toggle="pill" data-bs-target="#v-pills-10" type="button" role="tab">10. Upload Materials</button>
            </div>
        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="skill-card">
                                                    ...
                                                    <div class="skill-body">
                                                        <form id="personalInfoForm" action="{{ route('apply.save.step1') }}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            <!-- Hidden application ID if exists -->
                                                            @if($application)
                                                            ...
                                                            <div class="row g-3 mb-5 p-3 fav-shadow-border">
                                                                <div class="col-lg-3 col-md-4">
                                                                    ...
                                                                    <input type="file" id="picture" name="picture" class="dropify @error('picture') is-invalid @enderror" data-max-file-size="1M" data-allowed-file-extensions="jpg jpeg png" data-height="150" accept="image/*" required />
                                                                    @error('picture')
                                                            ...
                                                            <div class="row g-3 mb-5 p-3 fav-shadow-border">
                                                                <div class="col-lg-4 col-md-6">
                                                                    ...
                                                                    <input type="file" id="passport_picture" name="passport_picture" class="dropify @error('passport_picture') is-invalid @enderror" data-max-file-size="5M" data-allowed-file-extensions="jpg jpeg png" data-height="150" accept="image/*" required />
                                                            ...
                                                            <div class="row g-3 mb-5 p-3 fav-shadow-border">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <label for="family_name" class="form-label required-field">1.1A Family name (as shown on your passport, if any)</label>
                                                                    <input type="text" class="form-control @error('family_name') is-invalid @enderror" id="family_name" name="family_name" value="{{ old('family_name') }}" required>
                                                                    @error('family_name')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
                                                                <div class="col-lg-12">
                                                                    <label for="given_names" class="form-label required-field">1.1B Given name(s) (as shown on your passport, if any)</label>
                                                                    <input type="text" class="form-control @error('given_names') is-invalid @enderror" id="given_names" name="given_names" value="{{ old('given_names') }}" required>
                                                                    @error('given_names')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <label for="siberia_name" class="form-label">1.1D Siberia name (in Siberia, if any)</label>
                                                                    <input type="text" class="form-control @error('siberia_name') is-invalid @enderror" id="siberia_name" name="siberia_name" value="{{ old('siberia_name') }}">
                                                                    @error('siberia_name')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="row g-3 mb-5 p-3 fav-shadow-border">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <input type="text" id="dob" class="flat_date form-control @error('dob') is-invalid @enderror" name="dob" value="{{ old('dob') }}" required>
                                                                    @error('dob')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="row g-3 mb-5 p-3 fav-shadow-border">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <select id="birth_country_id" name="birth_country_id" class="select2 form-control @error('birth_country_id') is-invalid @enderror" required>
                                                                        ...
                                                                        <option value="{{ $country->id }}" {{ old('birth_country_id') == $country->id ? 'selected' : '' }}>{{ $country->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <input type="text" class="form-control @error('province_state') is-invalid @enderror" id="province_state" name="province_state" value="{{ old('province_state') }}" required>
                                                            ...
                                                            <div class="row g-3 mb-5 p-3 fav-shadow-border">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input @error('marital_status') is-invalid @enderror" type="radio" name="marital_status" id="married" value="married" {{ old('marital_status') == 'married' ? 'checked' : '' }}>
                                                                        <label class="form-check-label" for="married">Married</label>
                                                                    </div>
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input @error('marital_status') is-invalid @enderror" type="radio" name="marital_status" id="divorced" value="divorced" {{ old('marital_status') == 'divorced' ? 'checked' : '' }}>
                                                                        <label class="form-check-label" for="divorced">Divorced</label>
                                                                    </div>
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input @error('marital_status') is-invalid @enderror" type="radio" name="marital_status" id="single" value="single" {{ old('marital_status') == 'single' ? 'checked' : '' }}>
                                                                        <label class="form-check-label" for="single">Single</label>
                                                                    </div>
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input @error('marital_status') is-invalid @enderror" type="radio" name="marital_status" id="widowed" value="widowed" {{ old('marital_status') == 'widowed' ? 'checked' : '' }}>
                                                                        <label class="form-check-label" for="widowed">Widowed</label>
                                                                    </div>
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input @error('marital_status') is-invalid @enderror" type="radio" name="marital_status" id="others" value="others" {{ old('marital_status') == 'others' ? 'checked' : '' }}>
                                                            ...
                                                            <div class="row g-3 mb-5 p-3 fav-shadow-border">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <select id="current_nationality_id" name="current_nationality_id" class="select2 form-control @error('current_nationality_id') is-invalid @enderror" required>
                                                                        <option value="">--Select One--</option>
                                                                        @foreach ($countries as $country)
                                                                        <option value="{{ $country->id }}" {{ old('current_nationality_id') == $country->id ? 'selected' : '' }}>{{ $country->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input @error('other_nationality') is-invalid @enderror" type="radio" name="other_nationality" id="other_nationality_yes" value="yes" {{ old('other_nationality') == 'yes' ? 'checked' : '' }}>
                                                                        <label class="form-check-label" for="other_nationality_yes">Yes</label>
                                                                    </div>
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input @error('other_nationality') is-invalid @enderror" type="radio" name="other_nationality" id="other_nationality_no" value="no" {{ old('other_nationality') == 'no' ? 'checked' : '' }}>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input @error('permanent_resident_status') is-invalid @enderror" type="radio" name="permanent_resident_status" id="permanent_resident_status_yes" value="yes" {{ old('permanent_resident_status') == 'yes' ? 'checked' : '' }}>
                                                                        <label class="form-check-label" for="permanent_resident_status_yes">Yes</label>
                                                                    </div>
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input @error('permanent_resident_status') is-invalid @enderror" type="radio" name="permanent_resident_status" id="permanent_resident_status_no" value="no" {{ old('permanent_resident_status') == 'no' ? 'checked' : '' }}>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input @error('previous_nationalities') is-invalid @enderror" type="radio" name="previous_nationalities" id="previous_nationalities_yes" value="yes" {{ old('previous_nationalities') == 'yes' ? 'checked' : '' }}>
                                                                        <label class="form-check-label" for="previous_nationalities_yes">Yes</label>
                                                                    </div>
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input @error('previous_nationalities') is-invalid @enderror" type="radio" name="previous_nationalities" id="previous_nationalities_no" value="no" {{ old('previous_nationalities') == 'no' ? 'checked' : '' }}>
                                                            ...
                                                            <div class="row g-3 mb-5 p-3 fav-shadow-border">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input @error('passport_type') is-invalid @enderror" type="radio" name="passport_type" id="ordinary" value="ordinary" {{ old('passport_type') == 'ordinary' ? 'checked' : '' }}>
                                                                        <label class="form-check-label" for="ordinary">Ordinary</label>
                                                                    </div>
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input @error('passport_type') is-invalid @enderror" type="radio" name="passport_type" id="service" value="service" {{ old('passport_type') == 'service' ? 'checked' : '' }}>
                                                                        <label class="form-check-label" for="service">Service</label>
                                                                    </div>
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input @error('passport_type') is-invalid @enderror" type="radio" name="passport_type" id="diplomatic" value="diplomatic" {{ old('passport_type') == 'diplomatic' ? 'checked' : '' }}>
                                                                        <label class="form-check-label" for="diplomatic">Diplomatic</label>
                                                                    </div>
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input @error('passport_type') is-invalid @enderror" type="radio" name="passport_type" id="official" value="official" {{ old('passport_type') == 'official' ? 'checked' : '' }}>
                                                                        <label class="form-check-label" for="official">Official</label>
                                                                    </div>
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input @error('passport_type') is-invalid @enderror" type="radio" name="passport_type" id="special" value="special" {{ old('passport_type') == 'special' ? 'checked' : '' }}>
                                                                        <label class="form-check-label" for="special">Special</label>
                                                                    </div>
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input @error('passport_type') is-invalid @enderror" type="radio" name="passport_type" id="others" value="others" {{ old('passport_type') == 'others' ? 'checked' : '' }}>
                                                                        <label class="form-check-label" for="others">Others</label>
                                                                    </div>
                                                                    @error('passport_type')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <select id="issuing_country_id" name="issuing_country_id" class="select2 form-control @error('issuing_country_id') is-invalid @enderror" required>
                                                                        <option value="">--Select One--</option>
                                                                        @foreach ($countries as $country)
                                                                        <option value="{{ $country->id }}" {{ old('issuing_country_id') == $country->id ? 'selected' : '' }}>{{ $country->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <input type="text" class="form-control @error('place_of_issue') is-invalid @enderror" id="place_of_issue" name="place_of_issue" value="{{ old('place_of_issue') }}" required>
                                                                    @error('place_of_issue')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
                                                                <div class="col-lg-12">
                                                                    <label for="passport_expiration_date" class="form-label required-field">1.7E Expiration date (Please make sure your passport will be valid for no less than 6 months.)</label>
                                                                    <input type="text" id="passport_expiration_date" class="flat_date form-control @error('passport_expiration_date') is-invalid @enderror" name="passport_expiration_date" value="{{ old('passport_expiration_date') }}" required>
